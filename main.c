...
/*
  Builtin function implementations. */ /**
   ...
   @param args List of args.  args[0] is "cd".  args[1] is the 
directory.
...
/**
   ...
   @return 1 if the shell should continue running, 0 if it should 
terminate
 */ 
...
int main(int argc, char **argv) {
  ...
  // Run command loop.
  lsh_loop();
  // Perform any shutdown/cleanup. return EXIT_SUCCESS;
}
